...
Original file is located at
    https://colab.research.google.com/drive/1oBvtgNmdweXgHS_R9QerTZA0jSgCD8ff

Use neural style transfer on audio (and later text) sample to change the mood (to friendly)

[BERT with Hugging Face and Keras](https://towardsdatascience.com/multi-label-multi-class-text-classification-with-bert-transformer-and-keras-c6355eccb63a)

[Style transfer (on images) with TensorFlow](https://www.tensorflow.org/tutorials/generative/style_transfer)

Try to do it with a GAN i.e. like CycleGAN

- For content loss: not vector/cosine similarity, but (euclidean) distance
"""
...
[Twitter US Airline Sentiment from Kaggle](https://www.kaggle.com/crowdflower/twitter-airline-sentiment)

[Sentiment140 dataset from Kaggle](https://www.kaggle.com/kazanova/sentiment140)
"""
...
"""# Putting it all together: sentiment transfer"""
